...
(function(){
 ...
 // $("nav").not(".navbar").hide();
  ...
  $('body').on('click', '.afsmenu > .menu-item-has-children:not(.has-children__on)', function(e){
    ...
    $('body').on('click', '.animatedfsmenu__anchor .afsmenu > .menu-item-has-children.has-children__on, .afsmenu > li:not(.menu-item-has-children)', function(e){
